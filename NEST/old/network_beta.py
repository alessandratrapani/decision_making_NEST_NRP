...
tau_rise = [0.1,0.1,2.,0.1]
E_rev = [0.0,0.0,0.0,0.0]
...
nest.SetDefaults("aeif_cond_beta_multisynapse", exc_neuron_params)
pop_A = nest.Create("aeif_cond_beta_multisynapse", NA)
pop_B = nest.Create("aeif_cond_beta_multisynapse", NB)

nest.SetDefaults("aeif_cond_beta_multisynapse", inh_neuron_params)
pop_inh = nest.Create("aeif_cond_beta_multisynapse", NI)
...
# Input noise
nu_th_noise_ex = (np.abs(parameters['V_threshold'][0]) * parameters['C_m_ex'][0]) / (J_norm_noise * np.exp(1) * parameters['tau_m_ex'][0] * parameters['tau_syn_noise'][0])
...
nu_th_noise_in = (np.abs(parameters['V_threshold'][0]) * parameters['C_m_in'][0]) / (J_norm_noise * np.exp(1) * parameters['tau_m_in'][0] * parameters['tau_syn_noise'][0])
